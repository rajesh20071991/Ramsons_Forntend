...
import { GetshortPipeData } from "../../redux/actions/pipeAction";
...
const ShortViewData = () => {
  ...
  const short_data = useSelector((state) => state.PipeData.short_length);

  if (short_data) {
    var count = short_data.count;
    var shortdata = short_data.results;
  }
