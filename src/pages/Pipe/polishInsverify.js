...
import { GetPolishVerifyData } from "../../redux/actions/pipeAction";
...
const PipePolishVerify_data = () => {
  const Column_Col = [
    ...
    {
      title: "Diff Pipe",
      dataIndex: "noofpipe_difference",
      key: "noofpipe_difference",
      sorter: true,
      ellipsis: true,
      editable: true,
    },
  ...
  const nonpolishpipe = useSelector(
    (state) => state.PipeData.PolishVerify_Data
  );
  ...
  function export_data() {
    ...
    let url = config.apiEndpoint + "/api/polishlists/?token=" + key;
...
export default PipePolishVerify_data;
