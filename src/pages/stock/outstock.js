...
import { GetwithStockData } from "../../redux/actions/dispatchAction";
import { useDispatch } from "react-redux";
import Select from "react-select";
import Checkbox from "@material-ui/core/Checkbox";
import Sweet_Modal from "../../components/Common/react_modal";
import { SetModelId } from "../../redux/actions/modalAction";
import { Without_Stock_Col } from "../../components/Columns/stock";
...
const Without_Stock = () => {
  const data = useSelector((state) => state.DispatchData.withoutstock);
        ...
        <div className="border m-2 table_body table_body">
          <div className="container-fluid top_table">
            <div className="d-flex">
              ...
              <h4 className="filterPageTitle mt-2">#️⃣Without Pipe Stock</h4>
