...
import { GetDuromStockData } from "../../redux/actions/dispatchAction";
import { useDispatch } from "react-redux";
import Select from "react-select";
import Checkbox from "@material-ui/core/Checkbox";
import Sweet_Modal from "../../components/Common/react_modal";
import { SetModelId } from "../../redux/actions/modalAction";
import { Duromax_Stock_Col } from "../../components/Columns/stock";
...
const Duromax_Stock = () => {
  const data = useSelector((state) => state.DispatchData.duromaxstock);
        ...
        <div className="border m-2 table_body table_body">
          <div className="container-fluid top_table">
            <div className="d-flex">
              ...
              <h4 className="filterPageTitle mt-2">#️⃣Duromax Pipe Stock</h4>
