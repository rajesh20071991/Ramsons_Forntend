...
import { GetHistoryPOListData } from "../../redux/actions/storeActions";
...
const History_ListPO = () => {
  ...
  var purchaselist = useSelector((state) => state.store.adminpurchase_data);
        ...
        <div className="border m-2 table_body">
          <div className="container-fluid top_table">
            <div className="d-flex">
              ...
              <h4 className="filterPageTitle mt-2">#️⃣Purchase History List</h4>
