...
import { GetItemhListViewData } from "../../redux/actions/storeActions";
...
const ItemView_History = () => {
  ...
  let stocklist = useSelector((state) => state.store.ItemhListview_data);
        ...
        <div className="border m-2 table_body">
          <div className="container-fluid top_table">
            <div className="d-flex">
              ...
              <h4 className="filterPageTitle mt-2">#️⃣Item History</h4>
...
export default ItemView_History;
