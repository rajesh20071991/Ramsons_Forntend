...
import { GetApproveListData } from "../../redux/actions/storeActions";
...
const Final_Approve = () => {
  ...
  var purchaselist = useSelector((state) => state.store.eahpurchase_data);
  ...
  const { filter, setFilter, page, setPage } = useFilter("approvedfilter");
        ...
        <div className="border m-2 table_body">
          <div className="container-fluid top_table">
            <div
              ...
              <h4 className="filterPageTitle mt-2">
                #️⃣Final Approve Purchase List
              </h4>
