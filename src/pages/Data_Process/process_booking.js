...
import { Booking_Process_Col } from "../../components/Columns/tracking_process";
import { useSelector } from "react-redux";
import { GetbookingProcessData } from "../../redux/actions/data_processAction";
...
import { Company_Col } from "../../components/Columns/company_columns";
import Select from "react-select";

const Booking_Process = () => {
  var data = useSelector((state) => state.DataProcessData.bookingProcess_data);
  ...
  function Apply() {
    dispatch(GetbookingProcessData(page, size, filtr.name, filtr.id));
    closeModal();
  }
  ...
  // useEffect(() => {
  //   dispatch(GetbookingProcessData("/api/bookingmodel/"));
  // }, []);
  ...
  const getPaginatedData = (page) => {
    dispatch(GetbookingProcessData(page));
  };
        ...
        <div className="border m-2 table_body">
          <div className="container-fluid top_table">
            <div className="d-flex">
              ...
              <h4 className="filterPageTitle mt-2">#️⃣Booking Process</h4>
...
export default Booking_Process;
