...
import { GetProductProcessData } from "../../redux/actions/data_processAction";
...
const Production = () => {
  ...
  var productionfms = useSelector(
    (state) => state.DataProcessData.procductionProcess_data
  );
  if (productionfms) {
    var count = productionfms.count;
    var productionfms_data = productionfms.results;
  }
  ...
  const [filter, setFilter] = useState(() => {
    const storedFilter = localStorage.getItem("productionfmsFilter");
  ...
  const [page, setPage] = useState(() => {
    const storedPage = localStorage.getItem("productionfmsPage");
  ...
  useEffect(() => {
    localStorage.setItem("productionfmsFilter", JSON.stringify(filter));
  }, [filter]);

  useEffect(() => {
    localStorage.setItem("productionfmsPage", page.toString());
  }, [page]);
        ...
        <Form form={form} component={false}>
          {productionfms_data && (
            <Table
              ...
              bordered
              loading={productionfms_data === null}
