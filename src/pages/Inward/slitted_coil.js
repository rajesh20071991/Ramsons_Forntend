...
import { GetSlittedCoilData } from "../../redux/actions/inwardActions";
...
const SlittedCoil = () => {
  ...
  var slittedCoil = useSelector((state) => state.inwardData.slitted_coil_data);
  if (slittedCoil) {
    var count = slittedCoil.count;
    slittedCoil = slittedCoil.results;
  }
  const filtCols = {
    id: [],
    coil_no: "",
  ...
  const { filter, setFilter, page, setPage } = useFilter("silttfilter");
