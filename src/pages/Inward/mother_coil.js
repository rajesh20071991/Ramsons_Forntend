...
import { GetMotherCoilData } from "../../redux/actions/inwardActions";
...
import { Accessories_form } from "./Form/accesd_form";
...
const MotherCoil = () => {
  ...
  const { filter, setFilter, page, setPage } = useFilter("motherfilter");
